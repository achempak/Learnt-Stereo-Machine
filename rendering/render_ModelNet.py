# Inspired from https://github.com/ShapeNet/RenderForCNN
...
g_syn_light_energy_mean = 50 # Should be adjusted for every object category
...
bpy.ops.import_scene.obj(filepath=shape_file, axis_forward='-Y')

key_set = bpy.data.objects.keys()
key_set.remove('Lamp')
key_set.remove('Camera')
object_key = key_set[0]

bpy.data.objects[object_key].scale = (0.01,0.01,0.01)
