# modified from https://github.com/happyjin/ConvGRU-pytorch
...
class ConvGRU(nn.Module):
    def __init__(self, input_size, input_dim, hidden_dim, kernel_size, num_layers,
        ...
        for i in range(0, self.num_layers):
            ...
            cell_list.append(ConvGRUCell(input_size=(self.depth, self.height, self.width),
    ...
    def forward(self, input_tensor, hidden_state=None):
        ...
        :param input_tensor: (b, n, c, d, h, w)
        :param hidden_state:
